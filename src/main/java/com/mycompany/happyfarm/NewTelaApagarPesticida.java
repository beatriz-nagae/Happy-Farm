 ...
 * @author gabri
 */
public class NewTelaApagarPesticida extends javax.swing.JFrame {
   
    /**
     * Creates new form NewTelaGeral
     */
    public NewTelaApagarPesticida() {
        initComponents();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
          GerenciamentodePesticidasNaturais ge = new GerenciamentodePesticidasNaturais();
        ge.setCodPest(Integer.parseInt(intcodPest.getText()));
        ge.apagar();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewTelaApagarPesticida.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewTelaApagarPesticida().setVisible(true);
            }
        });
    }
